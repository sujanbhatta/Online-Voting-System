			...
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					<?php
						...
						$result = $db->prepare("SELECT * FROM logintbl");
						$result->execute();
					...
					<td><a class="text-danger" rel="facebox" href="disablelogin.php?id=<?php echo $row['id']; ?>"><i class="fa fa-toggle-on" aria-hidden="true" style="color:green;font-size:30px;"></i></a><td>
						<?php }  else if($row['status']==0) { ?>
						<td class="text-danger">Disabled</td>					
						<td><a class="text-success" rel="facebox" href="enablelogin.php?id=<?php echo $row['id']; ?>"> <i class="fa fa-toggle-off" aria-hidden="true" style="color:red;font-size:30px;"></i></a><td>
						<?php } ?>
					</tr>
					<?php
						}
