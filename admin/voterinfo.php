			...
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					...
					<tr class="record">
						...
						<td><a rel="facebox" href="editvoterimg.php?id=<?php echo $row['id']; ?>"><img src="voterimg/<?php echo $row['img']; ?>" /></a></td>
						
							<td><a rel="facebox" href="editvoter.php?id=<?php echo $row['id']; ?>"> Edit </a>
