		...
		<div class="container"> 
			<div class="row"> 
						...
						<div class="commission">
							...
							<div class="lists">
								<ul class="text-capitalize ">
									<li><a href="annual.php">Election Annual Report</a></li>
									<li><a href="laws.php">laws and procedures</a></li>
									<li><a href="#">video gallary</a></li>
									<li><a href="research.php">Research and Study</a></li>
				...
				<div class="col-md-7 middle-area"> 
					<h1 style="color:black">Study and Research</h1>
					<p>Election Commission of Nepal has always promoted and prioritized research and study to reform the electoral processes in Nepal. 
					To accelerate this, it has also established a section called "Research, Study and Foreign Relation Section" under the Electoral Education, Training and Foreign Relation Division. 
					To address the current issues and reform the electoral management practices, the following studies have been completed:</p>
					

   <li> Restructuring the Election Management Body in a Federal Set Up, study carried out in the Election Commission, Pakistan,</li>

    <li> Restructuring the Election Management Body in a Federal Set Up, study carried out in the Election Commission, India,</li>

    <li> Restructuring the Election Management Body in a Federal Set Up, study carried out in the Election Commission, Indonesia,</li>

     <li>Restructuring the Election Management Body in a Federal Set Up, study carried out in Independent Electoral Commission, South Africa,</li>

     <li>Feasibility Study on Overseas Voter Registration in Gulf and other Countries where there are a significant number of Nepalese Citizens in study and work service,</li>

     <li>Organization and Management Survey of the Election Commission.</li><br>
	 <a href="pdf/1.pdf">South Africa Study Visit Report</a><br>
	  <a href="pdf/2.pdf"> Indonesia Study Visit Report</a><br>
	   <a href="pdf/3.pdf"> India Visit Report</a>
	...
	<div class="footer-area2">
		<div class="copyright text-center"> 
			<p>EVS_EC_NP &copy;  2018 &nbsp; |&nbsp; All rights reserved.</p>
		</div>
	</div>
	<!-- footer-area ends -->
